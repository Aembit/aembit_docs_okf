...
5. **Authentication and Authorization** - The Access Policy’s

   Trust Providers cryptographically verify the Client Workload’s identity, and any Access Conditions are evaluated.
