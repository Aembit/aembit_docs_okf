---
type: reference
title: "GET /api/v2/credential-providers"
...
- **200**: Page of Credential Providers
  - `application/json`: [CredentialProviderV2DTOCredentialProviderListDTO](../schemas/credential-provider-v2-dto-credential-provider-list-dto.md)
- **400**: Bad Request
...
curl -X GET \
  ...
  "https://your-tenant.aembit.io/api/v2/credential-providers?page=example-value&per-page=example-value&filter=example-value&order=example-value&group-by=example-value"
```
