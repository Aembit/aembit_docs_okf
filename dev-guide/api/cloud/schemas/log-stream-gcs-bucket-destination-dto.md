---
type: reference
title: "LogStreamGCSBucketDestinationDTO"
...
- **gcsBucketName** *(optional)*: null,string
- **gcsPathPrefix** *(optional)*: null,string
- **audience** *(optional)*: null,string
- **serviceAccountEmail** *(optional)*: null,string
- **tokenLifetime** *(optional)*: integer (int32)
