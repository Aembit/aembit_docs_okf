...
- **clientWorkload** *(optional)*: [EntityMetaDTO](entity-meta-dto.md) - Client Workload associated with this Access Policy
- **serverWorkload** *(optional)*: [EntityMetaDTO](entity-meta-dto.md) - Server Workload associated with this Access Policy
