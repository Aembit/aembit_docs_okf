...
- **clientWorkloadDetails** *(optional)*: [WorkloadExternalDTO](workload-external-dto.md) - Details of the Client Workload associated with this Access Policy
- **serverWorkloadDetails** *(optional)*: [WorkloadExternalDTO](workload-external-dto.md) - Details of the Server Workload associated with this Access Policy
