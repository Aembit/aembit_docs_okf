---
type: reference
title: "CPTypeAembitAccessTokenV2DTO"
...
- **audience** *(required)*: string (your_tenant_id.api.aembit.io) - Audience for the access token
- **roleId** *(required)*: string (uuid) - Aembit Role Id
- **lifetimeInSeconds** *(required)*: integer (int32) - Access token lifetime (in seconds)
- **absoluteTokenLifetime** *(optional)*: null,integer (int32) - Absolute Lifetime of the Refresh Token. Setting a value indicates Refresh Token Support will be enabled.
