---
type: reference
title: "ServerWorkloadListDTO"
description: "Page of Server Workloads"
...
- **serverWorkloads** *(optional)*: Array of [ServerWorkloadExternalDTO](server-workload-external-dto.md)
