---
type: reference
title: "ListCredentialProviderIntegrationDTOListDTO"
...
- **entities** *(optional)*: Array of [ListCredentialProviderIntegrationDTO](list-credential-provider-integration-dto.md) - Page of entities for this request
