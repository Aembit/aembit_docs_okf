---
type: reference
title: "StandaloneCertificateResponseDTOListDTO"
...
- **entities** *(optional)*: Array of [StandaloneCertificateResponseDTO](standalone-certificate-response-dto.md) - Page of entities for this request
