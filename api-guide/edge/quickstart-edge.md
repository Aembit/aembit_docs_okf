...
resource: https://docs.aembit.io/api-guide/edge/quickstart-edge/
interface: api
tags: [edge]
...
* **Explore the [API Reference](https://docs.aembit.io/api-guide/edge/api-reference-edge)** for complete endpoint documentation
