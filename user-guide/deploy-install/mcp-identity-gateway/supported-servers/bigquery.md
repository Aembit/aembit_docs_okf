...
resource: https://docs.aembit.io/user-guide/deploy-install/mcp-identity-gateway/supported-servers/bigquery/
interface: mcp
...
>
> This page covers **MCP tool access through Aembit’s MCP Identity Gateway**. To broker credentials for the BigQuery REST API as a traditional Server Workload, see the [GCP BigQuery Server Workload guide](../../../access-policies/server-workloads/guides/gcp-bigquery.md) instead.
