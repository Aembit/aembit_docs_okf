...
resource: https://docs.aembit.io/user-guide/deploy-install/mcp-identity-gateway/supported-servers/microsoft-enterprise/
interface: mcp
...
>
> This page covers **MCP tool access through Aembit’s MCP Identity Gateway**. To broker credentials for the Microsoft Graph REST API as a traditional Server Workload, see the [Microsoft Graph Server Workload guide](../../../access-policies/server-workloads/guides/microsoft-graph.md) instead.
