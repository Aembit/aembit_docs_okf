...
resource: https://docs.aembit.io/user-guide/deploy-install/mcp-identity-gateway/supported-servers/databricks/
interface: mcp
...
>
> This page covers **MCP tool access through Aembit’s MCP Identity Gateway**. To broker credentials for the Databricks REST API as a traditional Server Workload, see the [Databricks Server Workload guide](../../../access-policies/server-workloads/guides/databricks.md) instead.
