...
resource: https://docs.aembit.io/user-guide/deploy-install/mcp-identity-gateway/supported-servers/salesforce/
interface: mcp
...
>
> This page covers **MCP tool access through Aembit’s MCP Identity Gateway**. To broker credentials for Salesforce’s REST API as a traditional Server Workload, see the [Salesforce Server Workload guide](../../../access-policies/server-workloads/guides/salesforce-rest.md) instead.
