...
resource: https://docs.aembit.io/user-guide/deploy-install/mcp-identity-gateway/supported-servers/slack/
interface: mcp
...
>
> This page covers **MCP tool access through Aembit’s MCP Identity Gateway**. To broker credentials for Slack’s REST API as a traditional Server Workload, see the [Slack Server Workload guide](../../../access-policies/server-workloads/guides/slack.md) instead.
