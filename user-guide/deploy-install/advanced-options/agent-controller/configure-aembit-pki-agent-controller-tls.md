...
2. Click on the **Edge Components** link in the left sidebar. Aembit opens the **Agent Controllers** page and lists your configured Agent Controllers.

   ![Agent Controllers page with the TLS column](https://docs.aembit.io/_astro/agent_controller_tls_status_page.DbQ7PSbi_23LdUF.webp)

3. Verify TLS is active by confirming color status button in the TLS column for the Agent Controller.
