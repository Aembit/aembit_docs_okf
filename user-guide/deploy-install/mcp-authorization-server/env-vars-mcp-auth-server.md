...
resource: https://docs.aembit.io/user-guide/deploy-install/mcp-authorization-server/env-vars-mcp-auth-server/
interface: mcp
...
For an example of how to use these environment variables in a Python MCP server, see [Test with a demo MCP server](../../access-policies/mcp-authorization-server/setup-mcp-auth-server.md#test-with-a-demo-mcp-server) in the setup guide.
