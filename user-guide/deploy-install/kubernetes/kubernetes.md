...
| [`aembit.io/metrics-scrape`](../../../reference/edge-components/cw-annotations.md#aembitiometrics-scrape)                               | Tells Prometheus whether to scrape metrics from Agent Proxy. *Example*: `"false"`                                                               |
| [`aembit.io/metrics-path`](../../../reference/edge-components/cw-annotations.md#aembitiometrics-path)                                   | Sets the path Prometheus requests when it scrapes Agent Proxy metrics. *Example*: `"/metrics"`                                                  |
| [`aembit.io/metrics-port`](../../../reference/edge-components/cw-annotations.md#aembitiometrics-port)                                   | Sets the port on which Agent Proxy exposes metrics. *Example*: `"9100"`                                                                         |
