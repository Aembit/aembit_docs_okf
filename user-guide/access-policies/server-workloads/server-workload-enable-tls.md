---
type: how-to
title: "Enable TLS on a Server Workload"
...
To enable TLS on traffic to your Server Workloads, do the following:

1. Log into your Aembit Tenant.

2. In the left sidebar menu, go to **Server Workloads**.
