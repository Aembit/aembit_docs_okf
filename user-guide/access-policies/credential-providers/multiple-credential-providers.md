...
| ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| **[AWS STS Federation Credential Providers](aws-security-token-service-multiple.md)** | - Access Key ID                                                 |
...
* [Configure an AWS STS Federation Credential Provider](aws-security-token-service-federation.md) - Configure single and multiple AWS STS Federation Credential Providers
