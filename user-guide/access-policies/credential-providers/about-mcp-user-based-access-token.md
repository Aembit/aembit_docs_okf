...
* You are configuring a **Gateway-to-Server** Access Policy for the [MCP Identity Gateway](../../deploy-install/mcp-identity-gateway/overview.md) and need per-user credential isolation
