...
resource: https://docs.aembit.io/user-guide/mcp-server/about-mcp-server/
tags: ["mcp-server"]
...
* **Tools:**
  ...
  * `get_workload_events`: Retrieve workload events
