...
resource: https://docs.aembit.io/user-guide/mcp-server/prompt-library/
interface: mcp
tags: ["prompt-library", "mcp-server"]
timestamp: 2026-09-15T18:18:13-07:00
---

# Prompt Library

The Prompt Library provides curated prompts for working with the [Aembit MCP Server](../overview.md). Use these prompts as starting points when querying audit logs, authorization events, and workload events through AI assistants and MCP-compatible clients.

This page assumes you have configured the MCP Server. See [Connect to the MCP Server](../connect/overview.md) for authentication and setup.
...
* [MCP Server reference](../reference-mcp-server.md) - Complete tool schemas, filter parameters, and example request/response formats
