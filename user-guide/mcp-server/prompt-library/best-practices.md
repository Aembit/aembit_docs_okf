...
resource: https://docs.aembit.io/user-guide/mcp-server/prompt-library/best-practices/
...
These ten best practices help you write more effective prompts for AI models, including when using the [Aembit MCP Server](../overview.md).
