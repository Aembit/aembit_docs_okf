...
resource: https://docs.aembit.io/ai-guide/mcp/mcp-servers-and-apps/
tags: [mcp]
...
* [MCP Identity Gateway concepts](identity-gateway/concepts-mcp-gateway.md) - Architecture and resource support details
* [Proxied MCP methods](identity-gateway/reference-mcp-gateway.md#proxied-mcp-methods) - Complete list of MCP methods the Identity Gateway proxies
