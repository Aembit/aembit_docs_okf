...
* **[Workload Events](../../../user-guide/audit-report/workload-events/overview.md)** — request and response traffic for MCP flows, with MCP-specific user and workload fields
