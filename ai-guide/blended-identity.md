...
resource: https://docs.aembit.io/ai-guide/blended-identity/
...
* [MCP Identity Gateway concepts](mcp/identity-gateway/concepts-mcp-gateway.md) - Blended identity in the full proxy model, including per-hop policy architecture
