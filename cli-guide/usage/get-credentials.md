...
resource: https://docs.aembit.io/cli-guide/usage/get-credentials/
interface: cli
tags: [usage]
...
[Section titled “Get credentials to access a Server Workload”](#get-credentials-to-access-a-server-workload)
...
[Section titled “Example commands”](#example-commands)
