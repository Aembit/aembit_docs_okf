...
resource: https://docs.aembit.io/cli-guide/usage/get-credentials-windows/
interface: cli
tags: [usage]
...
[Section titled “Get credentials using PowerShell script”](#get-credentials-using-powershell-script)
...
7. Configure the required script variables by updating these values in `get-credentials.ps1`:
   ...
   * `<clientWorkloadId>`: Set to your Client Workload ID
